...
def make_MRCB_layer(cnv_dim, curr_dim, out_dim):
    return nn.Sequential(
...
class exkp(nn.Module):
    ...
    def forward(self, image):
        ...
        outs = [self.upsampling(o['hm_c']) for o in outs]
        outs = [o.permute(0,2,3,1) for o in outs]
...
def StackedHourGlass(num_classes, num_stacks=2):
...
if __name__ == '__main__':
    ...
    model = StackedHourGlass(15).cuda()
